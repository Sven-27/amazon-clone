    ...
    return (
          <div className="Home">
            ...
            <div className="home__row">
                ...
                Creates Radically Succesful Business Paperback"
                price={11.96}
            ...
            <Product 
            id="4903850"
            title="Samsung LC49R90SUXEN 49' Curved LED Gaming Monitor"
            price={199.99}
            rating={3}
            ...
            <Product 
            id="90829332"
            title="Samsung Monitor LC49RG90SSUXEN 49' Curved LED Gaming Monitor - Super Ultra Wide
